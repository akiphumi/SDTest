...
"")
    ...
    def retranslateUi(self, Dataset):
        ...
        self.image_list_widget.topLevelItem(0).setText(0, _translate("Dataset", "Training images"))
        self.image_list_widget.topLevelItem(0).child(0).setText(0, _translate("Dataset", "Good product"))
        self.image_list_widget.topLevelItem(1).setText(0, _translate("Dataset", "Test images"))
        self.image_list_widget.topLevelItem(1).child(0).setText(0, _translate("Dataset", "Good product"))
        self.image_list_widget.topLevelItem(1).child(1).setText(0, _translate("Dataset", "Defective product"))
        self.image_list_widget.setSortingEnabled(__sortingEnabled)
        self.delete_images_button.setText(_translate("Dataset", "Delete"))
        self.number_of_images_label.setText(_translate("Dataset", "0image"))
        self.camera_and_images_button.setText(_translate("Dataset", "Add"))
        self.latest_training_date_label.setText(_translate("Dataset", "Previous training 2019/04/24"))
        self.train_button.setText(_translate("Dataset", "Training"))
        self.select_images_action.setText(_translate("Dataset", "Existing image "))
        self.select_images_action.setToolTip(_translate("Dataset", "Existing image"))
        self.camera_action.setText(_translate("Dataset", "Shoot with camera"))
        self.camera_action.setToolTip(_translate("Dataset", "Shoot with camera"))
